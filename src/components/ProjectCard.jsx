...
export default function ProjectCard({ image, title, description, location, delay = 0 }) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="p-6 bg-white dark:bg-slate-800">
        ...
        <p className="text-slate-600 dark:text-slate-400 text-sm mb-3">{description}</p>
        <div className="flex items-center justify-between">
          <span className="text-sm text-orange-500 font-medium">{location}</span>
          <motion.div
